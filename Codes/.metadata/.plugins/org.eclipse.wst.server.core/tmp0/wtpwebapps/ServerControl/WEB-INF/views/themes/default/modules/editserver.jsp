...
<aside class="right-side">
	...
	<section class="content">
		<div class="main-content">
			<spring:form action="${pageContext.request.contextPath }/editserver/${server.serverAddress}/${cc}"
				method="POST" role="form" commandName="server"
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<spring:password path="serverPassword"
								...
								placeholder="Input your server user password"
								required="required" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9">
							<spring:input path="port" class="port form-control"
								value="${server.port}" placeholder="SSH Port"
								required="required" />
						</div>
					</div>
