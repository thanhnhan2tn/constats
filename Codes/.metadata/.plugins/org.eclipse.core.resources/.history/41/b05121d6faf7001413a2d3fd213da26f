...
<aside class="right-side">
	...
	<section class="content-header">
		<h1>
			FTP Server Config :<small> (${server.serverAddress})</small>
		</h1>
...
<!-- 		</button> -->
	...
	$(document).ready(function () {
		...
		$.ajax({
	      url: '${pageContext.request.contextPath}/serviceconfig/ssh/getlogs/' + ip + '/' + cc
	      , type: 'GET'
	      , data: {}, //timeout : 60000,
		...
		$.ajax({
		      url: '${pageContext.request.contextPath}/serviceconfig/ssh/geterrors/' + ip + '/' + cc
		      , type: 'GET'
		      , data1: {}, //timeout : 60000,
