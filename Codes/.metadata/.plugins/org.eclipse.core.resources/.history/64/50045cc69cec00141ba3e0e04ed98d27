					...
					<c:if test="<%=(session.getAttribute(\"sudouser\") == null)%>">
						<div class="panel panel-default">
							<div style="padding-top: 30px" class="panel-body">
								<form action="${pageContext.request.contextPath }/serviceconfig/user/${server.serverAddress}/${cc}" class="form-horizontal" method="POST">
									...
									<div class="form-group ">
										<div class="col-md-9">
											<input class="form-control password" name="newpassword" type="password"
