			...
			<div class="col-sm-9 col-md-9">
				<div class="well">
					<form action="" method="POST" role="form" class="form-horizontal">
						<h3 class="nhd">Nhà phân phối trả lại hàng</h3>
						...
						<table class="table table-hover table-bordered table-striped"
							...
							<tbody>
								<tr>
									<td><input name='mahang0' type="text" class="form-control"></input></td>
									<td><input name='tenhang0' type="text" class="form-control"></input></td>
									<td><input name='soluong0' type="text" class="form-control"></input></td>
									<td><input name='dongia0' type="text" class="form-control"></input></td>
									<td><input name='dvtinh0' type="text" class="form-control"></input></td>
								</tr>
								<tr></tr>
							</tbody>
						</table>
						...
						<div class="form-group">
							<div class="col-md-12 text-center">
								<button type="submit" class="btn btn-primary button">Lưu</button>
