	...
	function submitAgreement() {
		$.ajax({
			...
			success : function(response) {
				$('#agreementContent').html(response);
			},
			error : function() {
	...
	<div class="container-fluid nopadding">
		...
		<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
			<div class="page-header">
				<h4>Reject Approval</h1>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<form action="updateRejectAgreement" method="POST" class="form-horizontal" role="form">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="agreementContent">
							<input type="hidden" name ="agreementId" value="${agreement.agreementId }"/>
							<div class="form-group">
								<label for="input" class="col-sm-2 control-label">RFO Number</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<div class="form-group">
								<label for="input" class="col-sm-2 control-label">Reasons
									</label>
								<div class="col-sm-10">
									<textarea name="reasonReject" class="form-control" rows="6"></textarea>
